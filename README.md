...
Текущая ветка исходников: **0.2.0**. [Переименование и совместимость](docs/ostojaos-renaming.md).
...
| --- | --- |
| [frontend](frontend/README.md) | React SPA: оболочка, страницы модулей, виджеты, настройки |
| [backend](backend/README.md) | Go core, привилегированный агент, рабочие процессы, API и системная интеграция |
| [docs](docs/README.md) | Требования, архитектура, задачи, документация и история исследований |
| [chassis](chassis/README.md) | Конструкция корпуса, CAD и материалы изготовления |
